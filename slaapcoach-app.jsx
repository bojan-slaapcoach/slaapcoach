...
export default function SlaapCoach() {
  ...
  const bg = "linear-gradient(160deg, #07050f 0%, #130d2a 45%, #0d1535 100%)";

  return (
    <div style={{ minHeight: "100vh", background: bg, fontFamily: "'DM Sans', sans-serif", color: "white", position: "relative", overflow: "hidden" }}>
      <style>{css}</style>
      <StarField />
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 460, margin: "0 auto", padding: "52px 22px 40px", animation: "fadeIn 0.6s ease-out" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: 44 }}>
            ...
            <div style={{ marginTop: 20, marginBottom: 6 }}>
              <h1 style={{
                fontSize: 36, fontWeight: "normal", letterSpacing: "-0.5px", margin: "0 0 6px",
          ...
          {/* Starters */}
          <p style={{ fontSize: 11, letterSpacing: "3px", textTransform: "uppercase", color: "#7c3aed", marginBottom: 13, textAlign: "center" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 11, marginBottom: 26 }}>
            {starters.map((s, i) => (
              <button key={i} onClick={() => startChat(s.text)} style={{
                ...
                border: "1px solid rgba(255,255,255,0.1)",
                borderRadius: 16, padding: "17px 14px",
          ...
          <div style={{ display: "flex", gap: 9 }}>
            ...
            />
            <button
              onClick={() => { if (input.trim()) startChat(input.trim()); }}
              style={{
                background: "linear-gradient(135deg, #7c3aed, #4f46e5)",
      ...
      {screen === "chat" && (
        <div style={{ position: "relative", zIndex: 2, maxWidth: 500, margin: "0 auto", height: "100vh", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{
            ...
            <button onClick={() => { setScreen("home"); setMessages([]); setError(null); }} style={{
              background: "none", border: "none", color: "rgba(255,255,255,0.45)",
              cursor: "pointer", fontSize: 19, padding: "0 6px 0 0", lineHeight: 1
            }}>←</button>
            <div style={{
              width: 38, height: 38, borderRadius: "50%",
              background: "linear-gradient(135deg, #7c3aed, #4f46e5)",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: 18, boxShadow: "0 0 14px rgba(124,58,237,0.45)"
            }}>🌙</div>
            <div>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "22px 18px 14px" }}>
            ...
            {error && (
              <div style={{ color: "#f87171", fontSize: 13, textAlign: "center", padding: "6px 0" }}>{error}</div>
            )}
            <div ref={bottomRef} />
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: 9, alignItems: "flex-end" }}>
              <textarea
                ...
                placeholder="Stel je vraag... (Enter om te sturen)"
                rows={1}
                style={{
                  flex: 1, background: "rgba(255,255,255,0.06)",
                  border: "1px solid rgba(255,255,255,0.13)",
